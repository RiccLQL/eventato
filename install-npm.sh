...
# Eventato - NPM Installation Script
# This script installs the eventato CLI tool via npm
...
echo -e "${BLUE}🚀 Eventato - NPM Installation${NC}"
echo ""
...
echo -e "${BLUE}📦 Installing eventato via npm...${NC}"
